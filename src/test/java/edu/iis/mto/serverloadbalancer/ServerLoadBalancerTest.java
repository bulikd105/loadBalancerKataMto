...
public class ServerLoadBalancerTest 
{
	...
	@Test
	public void aVm_shouldBeBalanced_onLessLoadedServerFisrt()
	{
		...
		assertThat("the less loadede server should contain vm", lessLoadedServer.contains(theVm));		
	}
	...
	public void balanceAServerWithNotEnoughRoom_shouldNotBeFilledWithAVm()
	{
		...
		asssertThat("the less loaded server should not contain vm", !theServer.contains(theVm));
	}
